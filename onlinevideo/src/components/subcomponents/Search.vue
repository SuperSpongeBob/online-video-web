                        ...
                        <template #default>
                            <el-card :body-style="{ padding: '0px', marginBottom: '1px' }"
                                ...
                                <img class="image" :src="movie.videoAlbum.videoPostPath"
                                    style="width: 240px; height: 180px" @click="goToMoviePage(movie)" />
    ...
    methods: {
        async fetchMovies() {
            try {
                ...
                const serverAddresss = authService.serverAddresss()
                    ...
                    if (item.videoAlbum) {
                        if (item.videoAlbum.videoPostPath) {
                            return {
                                ...
                                videoAlbum: {
                                    ...item.videoAlbum,
                                    videoPostPath: `${serverAddresss}/images/${item.videoAlbum.videoPostPath}`
                                }
                            };
                        } else {
                            return {
